...
class ImportExportAll implements FromView, WithEvents
{
    use Exportable;
    public $imports_all;

    public function __construct($imports_all = "")
    {
        $this->imports_all = $imports_all;
    }
    ...
    {
        return view('product-manage.import.exportall', [
            'imports_all' => $this->imports_all
        ]);
    }
}
