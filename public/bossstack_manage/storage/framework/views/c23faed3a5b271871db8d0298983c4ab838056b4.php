        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <font size="2" style="text-align: justify;"><b>Nếu bạn cần tư vấn để gia tăng thu nhập và hoàn thành mục tiêu tài chính, xin hãy liên hệ với chúng tôi để nhận được những lời khuyên tốt nhất. Hotline: 0918.905.500 (Zalo/Viber/Skype) hoặc Email: info@dongtiencanhan.com.</b></font>
                    </div>
                    
                    <div class="help">
                        <div class="row">
                            <div class="col-lg-2 col-md-4 col-sm-4" style="text-align: center;">
                                <a href="https://dongtiencanhan.com/public/advisorys/formAdvisory">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-4" style="text-align: center;">
                                <a href="https://dongtiencanhan.com/public/invests">
                                    <div class="icon" style="margin-bottom: 10px;">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-4" style="text-align: center;">
                                <a href="https://dongtiencanhan.com/public/cashs/process">
                                    <div class="icon" style="margin-bottom: 10px;">
