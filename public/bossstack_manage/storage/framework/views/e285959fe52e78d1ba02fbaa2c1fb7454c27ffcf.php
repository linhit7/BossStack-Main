    ...
    <section class="sidebar">
        ...
        <div class="user-panel clearfix">
            <div class="user-panel-avt">
                <div class="image">
                    <?php if(Auth::user()->customer()->first() != null and Auth::user()->customer()->first()->avatar != ''): ?>
                        <img src="<?php echo e(asset(Auth::user()->customer()->first()->avatar), false); ?>" class="img-circle" alt="<?php echo e(Auth::user() == null ? "" : mb_strtoupper(mb_substr(Auth::user()->name, 0, 1)), false); ?>">
                    <?php else: ?>
                        <p><b><?php echo e(Auth::user() == null ? "" : mb_strtoupper(mb_substr(Auth::user()->name, 0, 1)), false); ?></b></p>                                                                    
                    <?php endif; ?>
                </div>
            </div>
            <div class="user-panel-info">
                ...
                <div class="sign-out">
                    <a class="btn btn-default btn-flat" href="<?php echo e(route('logout'), false); ?>"
                        onclick="
                    ...
                    <?php $__currentLoopData = $module['applicationfunctiongroups']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $functiongroups): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="treeview">
                            <?php if(isset($functiongroups['filename']) and $functiongroups['filename'] != ''): ?>
                                <li class="list-menu"><a href="<?php echo e(route($functiongroups['filename']), false); ?>" data-name="<?php echo e($functiongroups['filename'], false); ?>"><i class="<?php echo e($functiongroups['image'], false); ?>"></i><?php echo e($functiongroups['name'], false); ?></a></li>
                            <?php else: ?>
                                <a href="#">
                            ...
                            <?php $__currentLoopData = $functiongroups['functionassignment']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $functionassignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(route($functionassignment['filename']), false); ?>" data-name="<?php echo e($functiongroups['filename'], false); ?>><i class="<?php echo e($functionassignment['image'], false); ?>"></i><?php echo e($functionassignment['name'], false); ?></a></li>
