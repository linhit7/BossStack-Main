            ...
            <div class="box-header">
                ...
                <div class="box-tools">
                    <div class="btn-group btn-group-sm">
                        <a class="btn btn-default clearfix" href="<?php echo e(route('users-add')); ?>"><i class="fa fa-plus" aria-hidden="true"></i> Tạo mới</a>
                    </div>
                    <div class="btn-group btn-group-sm">
                    ...
                    <div class="btn-group btn-group-sm">
                        <a class="btn btn-default" href="<?php echo e(route('users-export')); ?>"><i class="fa fa-download"></i> Xuất excel</a>
                    </div>
                </div>
            </div>
            <!-- /.box-header -->
