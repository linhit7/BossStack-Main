...
<html>
    <head>
        ...
        <script src="<?php echo e(asset('js/jquery.tabledit.js')); ?>"></script>

        <script src="<?php echo e(asset('bower_components/ckeditor/ckeditor.js')); ?>"></script>
        <script src="<?php echo e(asset('bower_components/ckeditor/ckfinder/ckfinder.js')); ?>"></script>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><b><font color="#2d3194"><?php echo e($title->heading); ?></font></b></h1>
                </section>
        ...
        <script src="<?php echo e(asset('bower_components/bootstrap-datepicker/dist/locales/bootstrap-datepicker.vi.min.js')); ?>"></script>
        <script src="<?php echo e(asset('bower_components/bootstrap-datetimepicker-master/build/js/bootstrap-datetimepicker.min.js')); ?>"></script>
        <link rel="stylesheet" href="<?php echo e(asset('bower_components/bootstrap-datetimepicker-master/build/css/bootstrap-datetimepicker.min.css')); ?>" />
