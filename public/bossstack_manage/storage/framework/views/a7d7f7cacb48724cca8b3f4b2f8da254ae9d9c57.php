    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-tools">
                    <a href="<?php echo e(route('applicationresources-add')); ?>" class="btn btn-default"><i class="fa fa-plus" aria-hidden="true"></i> Tạo mới</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="text-align: left;"><?php echo e($model->filename); ?></td>
                                <td style="text-align: left;"><?php echo e($model->prefix); ?></td>
                                <td style="text-align: center;"><a href="<?php echo e(route('securityresources-index', ['applicationresourceid'=>$model->code])); ?>">Phân quyền</a></td>
                                <td style="text-align: center;">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="<?php echo e(route('applicationresources-edit', ['id'=> $model->id])); ?>"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
                                            <li><a href="javascript:void(0)" data-id="<?php echo e($model->id); ?>" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                <form style="margin: 0;" name="form-delete-<?php echo e($model->id); ?>" method="post" action="<?php echo e(route('applicationresources-delete', ['id' => $model->id])); ?>">
            ...
            <div class="box-footer clearfix text-right">
                <?php echo e($collections->appends(array('searchprefix'=>$searchprefix,'searchfilename'=>$searchfilename))->links()); ?>                
            </div>
        </div>
    </div>
</div>
...
<form role="form" action="<?php echo e(route('applicationresources-getApplicationResources')); ?>?index=true" method="post" name="frm" id="frm">
<?php echo e(csrf_field()); ?>
