...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('img/fiinves-f-logo-tab.png')); ?>" sizes="32x32" />
...
<body style="font-family: 'Roboto', sans-serif !important;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 align-self-center">
                                            <div class="login-logo text-center">
                                                <img src="<?php echo e(asset('img/logo-finves.png')); ?>" alt="" width="30%">
                                            </div>

                                            <?php if(count($errors)>0): ?>
                                                <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="form-group has-feedback">
                                                <font color='#ff0000'><b><?php echo e($error); ?></b></font>
                                                </div>                  
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>                                        
                                            <?php if(Session::has('infor')): ?>
                                                <div class="form-group has-feedback">
                                                <font color='#ff0000'><b><?php echo e(Session::get('infor')); ?></b></font>
                                                </div>                  
                                            <?php endif; ?>
                                            <form action="<?php echo e(route('login')); ?>" method="post">
                                                ...
                                                <div class="form-group has-feedback">
                                                    <div class="input-group" id="show_hide_password">
                                                        <input type="password" class="form-control" placeholder="Password" name="password" id="password" required="required" value="<?php echo e(env('TEST_PASSWORD')); ?>">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-4">
                                                        <img id="captcha" name="captcha" src="<?php echo e(route('apiadmin-getCaptcha')); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group has-feedback">
                                                    <div class="forgot-password">
                                                        <a href="<?php echo e(route('customers-forgotPassword')); ?>" class="card-link"><b>Quên mật khẩu?</b></a>
                                                    </div>
                                                </div>
                                            ...
                                            <a href="<?php echo e(route('customers-register', ['service_product_id' => 1])); ?>" class="btn btn-primary btn-register" style="width: 100%; font-size: 1rem !important;"><b>ĐĂNG KÝ</b></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Fund JS -->
    <script src="<?php echo e(asset('js/fund.js')); ?>"></script>
    <!-- Fund JS -->
