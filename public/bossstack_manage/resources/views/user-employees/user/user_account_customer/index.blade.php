            ...
            <div class="box-header">
                ...
                <div class="box-tools">
                    <div class="btn-group btn-group-sm">
                        <a class="btn btn-default clearfix" href="{{ route('usercustomers-add') }}"><i class="fa fa-plus" aria-hidden="true"></i> Tạo mới</a>
                    </div>
                    <div class="btn-group btn-group-sm">
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="{{ route('usercustomers-index', filter_data($filter, 'limit', 10)) }}">10 dòng / trang</a></li>
                                <li><a href="{{ route('usercustomers-index', filter_data($filter, 'limit', 25)) }}">25 dòng / trang</a></li>
                                <li><a href="{{ route('usercustomers-index', filter_data($filter, 'limit', 50)) }}">50 dòng / trang</a></li>
                                <li><a href="{{ route('usercustomers-index', filter_data($filter, 'limit', 100)) }}">100 dòng / trang</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="btn-group btn-group-sm">
                        <a class="btn btn-default" href="{{ route('usercustomers-export') }}"><i class="fa fa-download"></i> Xuất excel</a>
                    </div>
                </div>
            </div>
            <!-- /.box-header -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="{{ route('usercustomers-edit', ['id' => $user->id]) }}"><i class="fas fa-pencil-alt"></i> Chỉnh sửa</a></li>
                                            <li>
                                                <a href="javascript:void(0)" data-id="{{ $user->id }}" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                <form name="form-delete-{{ $user->id }}" method="post" action="{{ route('usercustomers-delete', ['id'=> $user->id]) }}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}
                                                </form>
                                            </li>
