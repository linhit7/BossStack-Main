                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input type='text' class="form-control" name="begin_at_product" id='begin_at_product' value="{{ old('begin_at_product') }}"/>
                            ...
                            <div class="col-md-3">
                                <input type='text' class="form-control" name="finish_at_product" id='finish_at_product' value="{{ old('finish_at_product') }}"/>
