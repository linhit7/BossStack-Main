...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="{{ route('securityresources-store') }}?index=true" method="post" id="frm">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>View:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cview" value="1" {{ old( 'cview')==1 ? 'checked="checked"' : '' }}>
                    </div>  
                    <div class="form-group">
                        <label>Add:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cadd" value="1" {{ old( 'cadd')==1 ? 'checked="checked"' : '' }}>
                    </div> 
                    <div class="form-group">
                        <label>Delete:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cdelete" value="1" {{ old( 'cdelete')==1 ? 'checked="checked"' : '' }}>
                    </div> 
                    <div class="form-group">
                        <label>Update:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cupdate" value="1" {{ old( 'cupdate')==1 ? 'checked="checked"' : '' }}>
                    </div> 
                    <div class="form-group">
                        <label>Approve:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="capprove" value="1" {{ old( 'capprove')==1 ? 'checked="checked"' : '' }}>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" multiple id="cuserview" name="cuserview[]">                        
                            ...
                            @if( old('cuserview') != null )
                                @if( in_array($item->id, old('cuserview')) )
    ...
    <div class="col-md-4">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <a href="{{ route('securityresources-index', ['applicationresourceid'=>$applicationresourceid]) }}" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
            </div>
        </div>
    </div>
</div>
