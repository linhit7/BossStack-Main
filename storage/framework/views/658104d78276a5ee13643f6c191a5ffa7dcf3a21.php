<div class="box box-search">
    <form action="<?php echo e(route('applicationresources-index'), false); ?>">
        ...
        <div class="box-body">
            <div class="row">
                    ...
                    <select id="searchprefix" class="form-control" name="searchprefix">
                        ...
                        <?php $__currentLoopData = $listprefix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if( $value->prefix == $searchprefix ): ?>
                                <option value="<?php echo e($value->prefix, false); ?>" selected><?php echo e($value->prefix, false); ?></option>
                            <?php else: ?>
                                <option value="<?php echo e($value->prefix, false); ?>"><?php echo e($value->prefix, false); ?></option>
                            <?php endif; ?>
                ...
                <div class="col-xs-3">
                    ...
                    <input type="text" class="form-control" name="searchfilename" value="<?php echo e($searchfilename, false); ?>">
                </div>
                <div class="col-xs-3">
                    <label>&nbsp;</label><br>
