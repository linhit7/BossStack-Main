...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('dist/css/skins/_all-skins.min.css'), false); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('bower_components/morris.js/morris.css'), false); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('bower_components/jvectormap/jquery-jvectormap.css'), false); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(asset('bower_components/bootstrap-daterangepicker/daterangepicker.css'), false); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(asset('dist/css/AdminLTE.min.css'), false); ?>">

        <script src="<?php echo e(asset('js/jquery.min.js'), false); ?>"></script> 
        <script src="<?php echo e(asset('js/jquery.tabledit.js'), false); ?>"></script>

        <script src="<?php echo e(asset('bower_components/ckeditor/ckeditor.js'), false); ?>"></script>
        <script src="<?php echo e(asset('bower_components/ckeditor/ckfinder/ckfinder.js'), false); ?>"></script>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><b><font color="#2d3194"><?php echo e($title->heading, false); ?></font></b></h1>
                </section>
            ...
            <footer class="main-footer" style="display: none;">
                <div class="pull-right hidden-xs">
                    <b>Phiên bản</b> <?php echo e(config('app.version'), false); ?>
        ...
        <div class="loading-wrapper">
            <div class="loading">
                <img src="<?php echo e(asset('image/loading.svg'), false); ?>">
            </div>
        </div>
        <!-- ./wrapper -->
        ...
        <script src="<?php echo e(asset('bower_components/raphael/raphael.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('bower_components/morris.js/morris.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('bower_components/jquery-sparkline/dist/jquery.sparkline.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('plugins/jvectormap/jquery-jvectormap-world-mill-en.js'), false); ?>"></script>
        <script src="<?php echo e(asset('bower_components/jquery-knob/dist/jquery.knob.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('bower_components/moment/min/moment.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('bower_components/bootstrap-daterangepicker/daterangepicker.js'), false); ?>"></script>
        <script src="<?php echo e(asset('bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.js'), false); ?>"></script>
        <script src="<?php echo e(asset('plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('bower_components/jquery-slimscroll/jquery.slimscroll.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('bower_components/fastclick/lib/fastclick.js'), false); ?>"></script>
        <script src="<?php echo e(asset('dist/js/adminlte.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('bower_components/select2/dist/js/select2.full.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('plugins/iCheck/icheck.min.js'), false); ?>"></script>
        <script src="<?php echo e(asset('js/libs/sweetalert.min.js'), false); ?>"></script>

        <script src="<?php echo e(asset('js/rbooks.js'), false); ?>"></script>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/c3.css'), false); ?>">
        <script src="<?php echo e(asset('js/d3.v5.min.js'), false); ?>"></script>      
        <script src="<?php echo e(asset('js/c3.js'), false); ?>"></script>
        ...
        <script src="<?php echo e(asset('bower_components/bootstrap-datetimepicker-master/build/js/bootstrap-datetimepicker.min.js'), false); ?>"></script>
