...
<body>
    <table cellpadding=0 cellspacing=14 style="width:100%;font-family:Arial;font-size:13px;">
        ...
        <tr>
            <td colspan='2'>Tài khoản Fiinves Online Trading của Quý khách đã được cấp mật khẩu thành công.</td>
        </tr>
        <tr>
            <td colspan='2'>(Your password to Fiinves Online Trading account has been changed successfully).</td>
        </tr>
        <tr>
            <td colspan='2'>
        ...
        <tr>
            <td colspan='2'>
            - Mật khẩu đăng nhập mới (Password): <b>{{$userpassword}}</b>
            </td>
        </tr>
        <tr>
            <td colspan='2'>
