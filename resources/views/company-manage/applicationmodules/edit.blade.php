...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="{{ route('applicationmodules-update', ['id' => $model->id]) }}?continue=true" method="post" id="frm">
                {{ csrf_field() }}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="applicationmodulename" value="{{ $model->applicationmodulename }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" tabindex="4" name="hidden" value="1" id="chk-hidden" {{ $model->hidden==1 ? 'checked="checked"' : '' }}>
                    </div>                                           
                    <div class="form-group">
