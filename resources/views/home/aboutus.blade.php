  ...
  <div class="main-about">
        ...
        <div class="container">
          ...
          <div class="wrap">
            <div class="mission-content" data-aos="fade-right" data-aos-duration="1000">
              <h3>Sứ mệnh</h3>
              <h2>
                Chúng tôi giải phóng chủ doanh nghiệp khỏi gánh nặng quản lý
              </h2>
              <a href="#" class="btn btn-primary btn-contact">Liên hệ</a>
            </div>
            <img class="img-fluid mission-image" src="{{ asset('image/mission-img.png') }}"
              alt="" data-aos="fade-left" data-aos-duration="1000" />
          </div>
        </div>
    ...
    <div class="company-general">
          ...
          <div class="wrap">
            <div class="card-advertisement">
              <div class="card-body" data-aos="fade-right" data-aos-duration="1000">
                <h3>Về BossStack</h3>
                <p>
                  BossStack ra đời vào năm 2015 với mục đích đưa công nghệ vào
                  doanh nghiệp, nhằm hỗ trợ thực thi dự án, kiểm soát thất thoát
                  và giải quyết các vấn đề chuyên sâu về tài chính.
                </p>
                <p>
                  Áp dụng BossStack, hệ thống doanh nghiệp sẽ được vận hành một
                  cách tự động hiệu quả, đồng thời giúp chủ doanh nghiệp thực sự
                  <span class="highlight">"giải phóng"</span> ra khỏi các
                  <span class="highlight">"business"</span> của mình.
                </p>
              </div>
              <div class="card-image" data-aos="fade-left" data-aos-duration="1000">
                <img class="img-fluid" src="{{ asset('image/img-advertisement.png') }}"
                  alt="" />
              </div>
            </div>
          </div>
      ...
      <div class="section section-about section-about-leadership">
            ...
            <div class="card-leadership">
              <div class="card-item" data-aos="fade-down" data-aos-duration="1000">
                <div class="card-image">
                  <img class="img-fluid" src="{{ asset('image/leader-img-2.jpg') }}"
                    alt="" />
                </div>
                <div class="card-body">
                  <h4 class="leadership-name">
                    ...
                    <a href="#"><img class="img-fluid"
                        src="{{ asset('image/linkedin.svg') }}" alt="" /></a>
                  </h4>
                  <p class="leadership-des">CEO/Founder</p>
                  <div class="leadership-content">
                    <p>
                      Hơn 15 năm kinh nghiệm về tài chính, đầu tư và 10 năm kinh
                      nghiệm trong ngành ngân hàng
                    </p>
                    <ul>
                      ...
                      <li>
                        2012 - 2017: Giám đốc PGD, Phó Giám đốc Chi nhánh Ngân
                        hàng.
                      </li>
                    </ul>
                  </div>
              ...
              <div class="card-item" data-aos="fade-down" data-aos-duration="1000"
                data-aos-delay="500">
                <div class="card-image">
                  <img class="img-fluid" src="{{ asset('image/leader-img-1.jpg') }}"
                    alt="" />
                </div>
                <div class="card-body">
                  <h4 class="leadership-name">
                  ...
                  <div class="leadership-content">
                    ...
                    <p>
                      Chuỗi nhà hàng cao cấp và nổi tiếng trong ngành F&B như:
                    </p>
                    <ul>
                      <li>Ussina Sky 77</li>
                      <li>Ushi Mania</li>
                    ...
                    <p>
                      Chuỗi các thương hiệu đồ ăn nhanh của Mỹ trong ngành F &B
                      như:
                    </p>
                    <ul>
                      <li>Burger King</li>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <li>
                            Công ty NWFG của Tập đoàn UK với Garment factory &
                            Industry Park.
                          </li>
                        </ul>
                      </li>
              ...
              <div class="card-item" data-aos="fade-down" data-aos-duration="1000"
                data-aos-delay="1000">
                <div class="card-image">
                  <img class="img-fluid" src="{{ asset('image/leader-img-3.jpg') }}"
                    alt="" />
                </div>
                <div class="card-body">
                  <h4 class="leadership-name">
                  ...
                  <div class="leadership-content">
                    <p>
                      Hơn 20 năm kinh nghiệm trong ngành công nghệ thông tin và
                      Fin-tech
                    </p>
                    <ul>
                      <li>2020: Dự án Blockchain XIXO​</li>
                      <li>
                        2019 - 2020: Triển khai hệ thống ERP (SAGE) tại REDA -
                        Stricker
                      </li>
                      <li>
                        2017 - 2018: Phòng công nghệ thông tin và quản lý: Dự án
                        Digital Banking TP Bank
                      </li>
                      <li>
                        2014 - 2015: Quản lý hệ thống công nghệ thông tin cho dự
                        án nhà cửa VPBank.
                      </li>
                    </ul>
                  </div>
        ...
        <img class="img-fluid circle-disc" src="{{ asset('image/circle-disc.png') }}"
          alt="" />
      </div>
          ...
          <div class="wrap">
            ...
            <div class="history-list">
              <div class="history-item" data-aos="fade-up" data-aos-duration="1000">
                ...
                <img class="img-fluid icon" src="{{ asset('image/history-icon-1.png') }}"
                  alt="" />
              </div>

              <div class="history-item" data-aos="fade-up" data-aos-duration="1000">
                <span class="year">2015</span>
                <img class="img-fluid icon" src="{{ asset('image/history-icon-2.png') }}"
                  alt="" />
              </div>

              <div class="history-item" data-aos="fade-up" data-aos-duration="1000">
                <span class="year">2018</span>
                <img class="img-fluid icon" src="{{ asset('image/history-icon-3.png') }}"
                  alt="" />
                <div class="feature">
              ...
              <div class="history-item" data-aos="fade-up" data-aos-duration="1000">
                ...
                <img class="img-fluid icon" src="{{ asset('image/history-icon-4.png') }}"
                  alt="" />
                <div class="feature">
            ...
            <img class="img-fluid history-tree" src="{{ asset('image/history-tree.png') }}"
              alt="" />
          </div>
        </div>
        <img class="bg-circle" src="{{ asset('image/circle.png') }}" alt="" />
      ...
      <div class="container">
        <div class="wrap">
          <div class="accede-content">
            ...
            <p>
              BossStack luôn quan tâm, đầu tư vào việc phát triển con người và xem
              đây cũng là một trong những chiến lược phát triển lâu dài của công
              ty.
            </p>
          </div>
