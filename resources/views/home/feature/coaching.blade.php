        ...
        <div class="container">
          <div class="feature-wrap">
            <h3 class="section-title text-center">
              Lợi ích của tính năng Coaching
            </h3>
          ...
          <div class="wrap">
            <div class="card-advertisement">
              <div class="card-body">
                ...
                <ul class="advertisement-list">
                  ...
                  <li>
                    <img class="img-fluid" src="{{ asset('image/icon-right-sm.svg') }}"
                      alt="" />
                    Chủ doanh nghiệp thường không thể tách dòng tiền cá nhân của
                    mình ra khỏi doanh nghiệp
                  </li>
                  <li>
                    <img class="img-fluid" src="{{ asset('image/icon-right-sm.svg') }}"
                      alt="" />
              ...
              <div class="card-image">
                <img class="img-fluid" src="{{ asset('image/img-advertisement-3.png') }}"
                  alt="" />
              </div>
            </div>
          </div>
              ...
              <div class="card-body">
                ...
                <ul class="advertisement-list">
                  ...
                  <li>
                    <img class="img-fluid" src="{{ asset('image/icon-right-sm.svg') }}"
                      alt="" />
                    Khuyến nghị các mã chứng khoán và chiến lược đầu tư theo tháng
                    được cập nhật liên tục
                  </li>
                </ul>
              </div>
              <div class="card-image">
                <img class="img-fluid" src="{{ asset('image/img-advertisement-4.png') }}"
                  alt="" />
              </div>
            </div>
        ...
        <div class="container">
          <div class="wrap">
            <div class="card-advertisement">
              ...
              <div class="card-image">
                <img class="img-fluid" src="{{ asset('image/img-advertisement-5.png') }}"
                  alt="" />
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="wrap">
            <div class="card-advertisement reverse">
              ...
              <div class="card-image">
                <img class="img-fluid" src="{{ asset('image/img-advertisement-6.png') }}"
                  alt="" />
              </div>
            </div>
            <img class="img-fluid circle-disc-gray" src="{{ asset('image/circle-disc-gray.png') }}"
