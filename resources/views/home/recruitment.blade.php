...
@section('content')
  ...
  <div class="main-recruitment">
    <div class="section section-recruitment section-recruitment-bs">
      <div class="container">
        <div class="wrap">
          <div class="recruitment-bs-content">
            <h2>BossStack<br/>tuyển dụng</h2>
            <p>Ở BossStack chúng tôi đặt giá trị con người lên hàng đầu. Từ đó, mọi nhân viên đều được tạo điều kiện thuận lợi để cống hiến và phát triển toàn diện.</p>
            <a href="#position-hiring" class="btn btn-primary">Vị trí đang tuyển</a>
          </div>

          <img class="recruitment-bs-img" src="{{ asset('image/img-advertisement-11.png') }}" alt="">
        </div>
      </div>
    </div>
        ...
        <div class="wrap">
          ...
          <ul class="recruitment-list">
            <li class="recruitment-item">
              ...
              <a href="{{ route('recruitment-detail') }}" class="btn btn-primary btn-detail">Xem chi tiết</a>
            </li>
